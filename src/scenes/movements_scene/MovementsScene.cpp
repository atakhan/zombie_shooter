...
void MovementsScene::Init() {
    ...
    // float defaultAngle = 160.0f; // passed
    // float defaultAngle = 80.0f; // passed
    // float defaultAngle = 40.0f; // passed
    // float defaultAngle = 20.0f; // passed
    // float defaultAngle = 0.0f; // passed
    float defaultAngle = -20.0f; // passed
