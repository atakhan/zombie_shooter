#ifndef SRC_ENTITIES_MENU_COMPONENTS_MENU_COMPONENT_H
#define SRC_ENTITIES_MENU_COMPONENTS_MENU_COMPONENT_H
...
#endif // SRC_ENTITIES_MENU_COMPONENTS_MENU_COMPONENT_H
