#ifndef SRC_ENTITIES_COLLIDER_SYSTEMS_COLLIDER_RESOLVER_SYSTEM_H
#define SRC_ENTITIES_COLLIDER_SYSTEMS_COLLIDER_RESOLVER_SYSTEM_H
...
#endif // SRC_ENTITIES_COLLIDER_SYSTEMS_COLLIDER_RESOLVER_SYSTEM_H
